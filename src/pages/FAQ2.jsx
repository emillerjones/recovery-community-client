...
const groupId = (title) =>
  `faq2-${title.toLowerCase().replaceAll(" ", "-").replaceAll("&", "and")}`;
...
function ConversationArt() {
  return (
    <svg className="faq2-hero__art" viewBox="0 0 560 390" aria-hidden="true">
      <path className="faq2-hero__orbit" d="M48 198C48 91 142 31 282 31c142 0 230 62 230 168 0 108-91 162-232 162S48 306 48 198Z" />
      <path className="faq2-hero__bubble faq2-hero__bubble--back" d="M256 73h178c31 0 56 25 56 56v64c0 31-25 56-56 56h-53l-43 38 8-38h-90c-31 0-56-25-56-56v-64c0-31 25-56 56-56Z" />
      <path className="faq2-hero__bubble" pathLength="1" d="M108 129h203c34 0 61 27 61 61v72c0 34-27 61-61 61h-82l-56 43 14-43h-79c-34 0-61-27-61-61v-72c0-34 27-61 61-61Z" />
      <path className="faq2-hero__question" pathLength="1" d="M170 207c3-27 22-43 49-43 29 0 50 17 50 43 0 34-43 37-43 65M226 294v2" />
      <path className="faq2-hero__answer" pathLength="1" d="M287 134h116M287 165h87" />
      <circle className="faq2-hero__point" cx="93" cy="84" r="4" />
      <circle className="faq2-hero__point" cx="467" cy="314" r="4" />
    </svg>
  );
}
  ...
  return (
    <main className="faq2">
      <section className="faq2-hero">
        <div className="faq2-hero__glow" aria-hidden="true" />
        <div className="faq2-container faq2-hero__inner">
          <div className="faq2-hero__copy">
            <p className="faq2-kicker">A clear place to begin</p>
            <h1>Good questions deserve honest answers.</h1>
            <p className="faq2-hero__intro">
      ...
      <section className="faq2-closing">
        <div className="faq2-closing__rings" aria-hidden="true">
          <i />
          <i />
          <i />
        </div>
        <div className="faq2-container faq2-closing__inner">
          <p className="faq2-kicker">The question after the questions</p>
