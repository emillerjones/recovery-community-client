...
const categoryId = (title) =>
  `discount2-${title.toLowerCase().replaceAll("&", "and").replaceAll(/[^a-z0-9]+/g, "-").replace(/-$/, "")}`;
...
export default function DiscountLinks2() {
  ...
  return (
    <main className="discount-page discount2-study">
      <section className="discount-hero">
        <div className="discount-inner discount-hero__inner">
          <div className="discount-hero__copy">
            ...
            <nav className="discount2-index" aria-label="Discount categories">
