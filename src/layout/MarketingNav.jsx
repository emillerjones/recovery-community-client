...
import { BadgePercent, BarChart3, BookHeart, BookOpen, ChevronRight, CircleHelp, Flag, Flame, Heart, HeartHandshake, LayoutGrid, LogOut, Mail, MessageCircle, ScrollText, ShieldCheck, ShoppingBag, Sprout, StickyNote, UserCheck, UsersRound } from "lucide-react";
...
export default function MarketingNav({ onLogin, onRegister }) {
  ...
  const loungeAvailable = ["/today", "/grove", "/wall", "/forum", "/messages", "/profile", "/admin"].some(
      ...
      <nav className="main-nav" aria-label="Primary navigation">
        {token ? (
          <>
            ...
            <NavLink to="/grove" className="main-nav__link main-nav__link--forum">Grove</NavLink>
          ...
          {token ? (
            <>
              ...
              <div className="mobile-nav__member-shortcuts">
                ...
                <NavLink to="/grove" onClick={closeMenu}><Sprout size={21} /><strong>Grove</strong><small>Check in together</small></NavLink>
