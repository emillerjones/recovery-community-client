...
import { BadgePercent, BarChart3, BookHeart, BookOpen, ChevronRight, CircleHelp, Compass, Flag, Flame, Heart, HeartHandshake, LayoutGrid, LogOut, Mail, MessageCircle, ScrollText, ShieldCheck, ShoppingBag, UserCheck, UsersRound } from "lucide-react";
...
export default function MarketingNav({ onLogin, onRegister }) {
  ...
  const loungeAvailable = ["/today", "/journey", "/forum", "/messages", "/profile", "/admin"].some(
      ...
      <nav className="main-nav" aria-label="Primary navigation">
        {token ? (
          <>
            ...
            <NavLink to="/journey" className="main-nav__link main-nav__link--forum">Journey</NavLink>
          ...
          {token ? (
            <>
              ...
              <div className="mobile-nav__member-shortcuts">
                ...
                <NavLink to="/journey" onClick={closeMenu}><Compass size={21} /><strong>Journey</strong><small>Travel recent conversations</small></NavLink>
