    ...
    <footer className="marketing-footer">
      <div className="marketing-footer__inner">
        <div className="marketing-footer__brand">
          <p className="marketing-footer__eyebrow">Recovery community</p>

          <h2>No one should have to recover alone.</h2>

          <p>
            Recovery With The Exit Drug is a welcoming community exploring
            cannabis as a path away from alcohol, opioids, and other harmful
            substances.
          </p>

          <NavLink to="/register" className="marketing-footer__cta">
            Join the Community
          </NavLink>
        </div>
